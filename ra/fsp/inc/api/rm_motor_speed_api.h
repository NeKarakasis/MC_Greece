...
typedef enum e_motor_speed_control_mode
{
    MOTOR_SPEED_CONTROL_MODE_SPEED = 0,
    MOTOR_SPEED_CONTROL_MODE_TORQUE
} motor_speed_control_mode_t;
...
typedef struct st_motor_speed_api
{
    ...
    /** Set torque reference into the motor speed module.
        *
        * @param[in]  p_ctrl                Pointer to control structure.
        * @param[in]  torque_reference_mnm  Torque reference [mNm]
        */
       fsp_err_t (* torqueReferenceSet)(motor_speed_ctrl_t * const p_ctrl, float const torque_reference_mnm);

       /** Set motor control mode.
        *
        * @param[in]  p_ctrl  Pointer to control structure.
        * @param[in]  mode    Speed or torque control mode.
        */
       fsp_err_t (* controlModeSet)(motor_speed_ctrl_t * const p_ctrl, motor_speed_control_mode_t const mode);
