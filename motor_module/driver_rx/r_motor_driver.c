                                  ...
                                  float * p_f4_vdc_ad)
{
    ...
    *p_f4_iu_ad  = (3.1975f - st_ad_data.u2_iu_ad * f4_volt_per_digit) / 0.96f;
    *p_f4_iw_ad  = (3.1975f - st_ad_data.u2_iw_ad * f4_volt_per_digit) / 0.96f;
    *p_f4_iv_ad  = (3.1975f - st_ad_data.u2_iv_ad * f4_volt_per_digit) / 0.96f;
                                ...
                                float * p_f4_vdc)
{
    ...
    *p_f4_iu  = (3.1975f - p_st_adc_raw->u2_iu_ad * f4_volt_per_digit) / 0.96f;
    *p_f4_iv  = (3.1975f - p_st_adc_raw->u2_iv_ad * f4_volt_per_digit) / 0.96f;
    *p_f4_iw  = (3.1975f - p_st_adc_raw->u2_iw_ad * f4_volt_per_digit) / 0.96f;
