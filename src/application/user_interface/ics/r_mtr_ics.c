...
/*real time handling of HFI parameters*/
float         com_f4_volt_pulse_inj_boot_on_the_fly = 220;
float         com_f4_volt_pulse_inj_running_on_the_fly = 160;
uint8_t       com_u1_pulse_freq_boot_on_the_fly   = 8;
uint8_t       com_u1_pulse_freq_drive_on_the_fly  = 4;
...
void r_app_rmw_interrupt_handler(void)
{
    ...
    if (ICS_DECIMATION < s_u1_cnt_ics)
    {
        ...
        /* Call ICS */
      	 if(g_u1_on_the_fly_activate==0){

       		 com_f4_volt_pulse_inj_boot_on_the_fly = 220;
       		 com_f4_volt_pulse_inj_running_on_the_fly = 160;
       	     com_u1_pulse_freq_boot_on_the_fly = 8;
       		 com_u1_pulse_freq_drive_on_the_fly = 4;
