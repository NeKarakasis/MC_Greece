...
#define    MTR_MOTOR_PARAMETER1     (0)

#define MOTOR_SPEED_TORQUE_LIMIT_MARGIN    (0.90F)
...
#define    MP_POLE_PAIRS1           (4)                     /* Number of pole pairs */
#define    MP_RESISTANCE1           (1.3f)                  /* Resistance [ohm] */
#define    MP_D_INDUCTANCE1         (0.0013f)               /* D-axis inductance [H] */
#define    MP_Q_INDUCTANCE1         (0.0013f)               /* Q-axis inductance [H] */
#define    MP_MAGNETIC_FLUX1        (0.01119f)              /* Permanent magnetic flux [Wb] */
#define    MP_ROTOR_INERTIA1        (0.000003666f)          /* Rotor inertia [kgm^2] */
#define    MP_NOMINAL_CURRENT_RMS1  (1.67f)                 /* Nominal current [Arms] */
