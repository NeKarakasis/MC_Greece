...
#define    MTR_CONTROL_PARAMETER1     (0)
...
#define    CP_CURRENT_OMEGA1        (300.0f)                /* Natural frequency for current loop */
#define    CP_CURRENT_ZETA1         (1.0f)                  /* Damping ratio for current loop */
#define    CP_SPEED_OMEGA1          (5.0f)                  /* Natural frequency for speed loop */
#define    CP_SPEED_ZETA1           (1.0f)                  /* Damping ratio for speed loop */
#define    CP_E_OBS_OMEGA1          (1000.0f)               /* Natural frequency of BEMF observer */
#define    CP_E_OBS_ZETA1           (1.0f)                  /* Damping ratio of BEMF observer */
#define    CP_PLL_EST_OMEGA1        (20.0f)                 /* Natural frequency of PLL Speed estimate loop */
#define    CP_PLL_EST_ZETA1         (1.0f)                  /* Damping ratio of PLL Speed estimate loop */
#define    CP_ID_DOWN_SPEED_RPM1    (500)                   /* Speed to start decreasing id [rpm]  (mechanical) */
#define    CP_ID_UP_SPEED_RPM1      (400)                   /* Speed to start increasing id [rpm]  (mechanical) */
#define    CP_MAX_SPEED_RPM1        (2400)                  /* Maximum speed[rpm] (mechanical) */
#define    CP_OVERSPEED_LIMIT_RPM1  (4500)                  /* Over speed limit [rpm] (mechanical) */
#define    CP_OL_ID_REF1            (0.3f)                  /* Id reference when low speed [A] */
