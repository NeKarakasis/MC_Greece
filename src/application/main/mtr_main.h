...
#define MTR_ADCH_VR2             (17)                           /* A/D channel of vr1 */

#define MTR_PORT_SW1_1           (BSP_IO_PORT_10_PIN_00)        /* Input port of SW1_1 */
#define MTR_PORT_SW2_1           (BSP_IO_PORT_10_PIN_07)        /* Input port of SW2_1 */

#define MTR_PORT_SW1_2           (BSP_IO_PORT_09_PIN_01)        /* Input port of SW1_2 */
#define MTR_PORT_SW2_2           (BSP_IO_PORT_03_PIN_13)        /* Input port of SW2_2 */

#define MTR_PORT_LED1_1          (BSP_IO_PORT_06_PIN_14)        /* Output port of LED1_1 */
#define MTR_PORT_LED2_1          (BSP_IO_PORT_10_PIN_15)        /* Output port of LED2_1 */
#define MTR_PORT_LED3_1          (BSP_IO_PORT_10_PIN_04)        /* Output port of LED3_1 */

#define MTR_PORT_LED1_2          (BSP_IO_PORT_09_PIN_00)        /* Output port of LED1_2 */
#define MTR_PORT_LED2_2          (BSP_IO_PORT_05_PIN_09)        /* Output port of LED2_2 */
#define MTR_PORT_LED3_2          (BSP_IO_PORT_05_PIN_10)        /* Output port of LED3_2 */
