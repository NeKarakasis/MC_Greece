...
/* Select sensor set in FSP sensor1/2 module*/
#define MOTOR_SENSOR_1           (MOTOR_SENSOR_BEMF)            /* sensor set in sensor module 1 */
#define MOTOR_SENSOR_2           (MOTOR_SENSOR_BLANK)           /* sensor set in sensor module 2 */
#define MOTOR_SENSOR_BLANK       (0)                            /* Nothing set in Sensor stack */
#define MOTOR_SENSOR_BEMF        (1)                            /* OPENLOOP + BEMF FOC */
#define MOTOR_SENSOR_HALL        (2)                            /* Hall FOC */

#define MTR_ADCH_VR1             (16)                           /* A/D channel of vr1 */
