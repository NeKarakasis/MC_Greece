...
float pfc_filter_lpff(float f4_lpf_input, float f4_pre_lpf_output, float f4_lpf_k)
{
    ...
    return (f4_temp);
} /* End of function pfc_filter_lpff */

/***********************************************************************************************************************
* Function Name : pfc_filter_limitf
...
float pfc_filter_limitf(float f4_value, float f4_max, float f4_min)
{
    ...
    return (f4_temp);
} /* End of function pfc_filter_limitf */

/***********************************************************************************************************************
* Function Name : pfc_filter_limit
* Description   : Limit with maximum limit and minimum limit
...
int16_t pfc_filter_limit(int16_t s2_value, int16_t s2_max, int16_t s2_min)
{
    ...
    return (s2_temp);
} /* End of function pfc_filter_limit */

/***********************************************************************************************************************
* Function Name : pfc_filter_upper_limitf
...
float pfc_filter_upper_limitf(float f4_value, float f4_max)
{
    ...
    return (f4_temp);
} /* End of function pfc_filter_upper_limitf */

/***********************************************************************************************************************
* Function Name : pfc_filter_upper_limit
* Description   : Limit with maximum limit
* Arguments     : s2_value - Target value
                  s2_max   - Maximum limit
* Return Value  : Limited target value
...
int16_t pfc_filter_upper_limit(int16_t s2_value, int16_t s2_max)
{
    ...
    return (s2_temp);
} /* End of function pfc_filter_upper_limit */

/***********************************************************************************************************************
* Function Name : pfc_filter_lower_limitf
...
float pfc_filter_lower_limitf(float f4_value, float f4_min)
{
    ...
    return (f4_temp);
} /* End of function pfc_filter_lower_limitf */

/***********************************************************************************************************************
* Function Name : pfc_filter_lower_limit
* Description   : Limit with minimum limit
* Arguments     : s2_value - Target value
                  s2_min   - Minimum limit
* Return Value  : Limited target value
...
int16_t pfc_filter_lower_limit(int16_t s2_value, int16_t s2_min)
{
    ...
    return (s2_temp);
} /* End of function pfc_filter_lower_limit */

/***********************************************************************************************************************
* Function Name : pfc_filter_limitf_abs
...
float pfc_filter_limitf_abs(float f4_value, float f4_limit_value)
{
    ...
    return (f4_value);
} /* End of function pfc_filter_limitf_abs */

/***********************************************************************************************************************
* Function Name : pfc_filter_limit_abs
* Description   : Limit with absolute value
* Arguments     : s2_value       - Target value
...
int16_t pfc_filter_limit_abs(int16_t s2_value, int16_t s2_limit_value)
{
    ...
    return (s2_temp0);
} /* End of function pfc_filter_limit_abs */

/***********************************************************************************************************************
* Function Name : pfc_filter_second_order_lpff_init
...
} /* End of function pfc_filter_second_order_lpff_init */

/***********************************************************************************************************************
* Function Name : pfc_filter_second_order_lpff_reset
...
void pfc_filter_second_order_lpff_reset(st_pfc_2nd_order_lpf_t *p_st_lpf)
{
    ...
    p_st_lpf->f4_pre_input        = 0.0f;
    p_st_lpf->f4_pre2_input       = 0.0f;
} /* End of function pfc_filter_second_order_lpff_reset */

/***********************************************************************************************************************
* Function Name : pfc_filter_second_order_lpff_gain_calc
...
* Return Value  : None
***********************************************************************************************************************/
void pfc_filter_second_order_lpff_gain_calc(st_pfc_2nd_order_lpf_t *p_st_lpf,
                                            float f4_omega,
                                            float f4_zeta,
                                            float f4_ctrl_period)
{
    ...
    p_st_lpf->f4_omega_t   = (PFC_TWOPI * f4_omega) * f4_ctrl_period;            /* w*T */
    p_st_lpf->f4_omega2_t  = p_st_lpf->f4_omega_t * (PFC_TWOPI * f4_omega);      /* w^2*T */
...
} /* End of function pfc_filter_second_order_lpff_gain_calc */

/***********************************************************************************************************************
* Function Name : pfc_filter_second_order_lpff
...
float pfc_filter_second_order_lpff(st_pfc_2nd_order_lpf_t *p_st_lpf, float f4_input)
{
    ...
    return (f4_output);
} /* End of function pfc_filter_second_order_lpff */

/***********************************************************************************************************************
* Function Name : pfc_filter_first_order_lpff_init
...
void pfc_filter_first_order_lpff_init(st_pfc_1st_order_lpf_t *p_st_lpf)
{
    ...
    p_st_lpf->f4_gain_ka      = 0.0f;
    p_st_lpf->f4_gain_kb      = 0.0f;
} /* End of function pfc_filter_first_order_lpff_init */

/***********************************************************************************************************************
* Function Name : pfc_filter_first_order_lpff_reset
...
void pfc_filter_first_order_lpff_reset(st_pfc_1st_order_lpf_t *p_st_lpf)
{
    p_st_lpf->f4_pre_output   = 0.0f;
    p_st_lpf->f4_pre_input    = 0.0f;
} /* End of function pfc_filter_first_order_lpff_reset */

/***********************************************************************************************************************
* Function Name : pfc_filter_first_order_lpff_gain_calc
...
{
    p_st_lpf->f4_omega_t = (PFC_TWOPI * f4_omega) * f4_ctrl_period;
...
} /* End of function pfc_filter_first_order_lpff_gain_calc */

/***********************************************************************************************************************
* Function Name : pfc_filter_first_order_lpff
...
float pfc_filter_first_order_lpff(st_pfc_1st_order_lpf_t *p_st_lpf, float f4_input)
{
    ...
    return (f4_temp0);
} /* End of function pfc_filter_first_order_lpff */

/***********************************************************************************************************************
* Function Name : pfc_filter_notch_init
* Description   : Initialize notch filter
* Arguments     : p_st_notch_fil - Notch filter structure (pointer)
* Return Value  : None
***********************************************************************************************************************/
void pfc_filter_notch_init(st_pfc_notch_fil_t *p_st_notch_fil)
{
    p_st_notch_fil->f4_coef_n[0]     = 0.0f;
    p_st_notch_fil->f4_coef_n[1]     = 0.0f;
    p_st_notch_fil->f4_coef_n[2]     = 0.0f;
    p_st_notch_fil->f4_coef_d[0]     = 0.0f;
    p_st_notch_fil->f4_coef_d[1]     = 0.0f;
    p_st_notch_fil->f4_coef_d[2]     = 0.0f;
    p_st_notch_fil->f4_in_data[0]    = 0.0f;
    p_st_notch_fil->f4_in_data[1]    = 0.0f;
    p_st_notch_fil->f4_in_data[2]    = 0.0f;
    p_st_notch_fil->f4_out_data[0]   = 0.0f;
    p_st_notch_fil->f4_out_data[1]   = 0.0f;
    p_st_notch_fil->f4_out_data[2]   = 0.0f;
    p_st_notch_fil->f4_omega_t       = 0.0f;
} /* End of function pfc_filter_notch_init */

/***********************************************************************************************************************
* Function Name : pfc_filter_notch_reset
* Description   : Reset notch filter
* Arguments     : p_st_notch_fil - Notch filter structure (pointer)
* Return Value  : None
***********************************************************************************************************************/
void pfc_filter_notch_reset(st_pfc_notch_fil_t *p_st_notch_fil)
{
    ...
    p_st_notch_fil->f4_out_data[1]   = 0.0f;
    p_st_notch_fil->f4_out_data[2]   = 0.0f;
} /* End of function pfc_filter_notch_reset */

/***********************************************************************************************************************
* Function Name : pfc_filter_notch_coef_calc
* Description   : Coefficient calculation for notch filter
* Arguments     : p_st_notch_fil - Notch filter structure (pointer)
*                 f4_samp_period - Sampling period
*                 f4_d           - Notch depth
*                 f4_zeta        - Notch width
* Return Value  : None
***********************************************************************************************************************/
                                ...
                                float f4_zeta)
{
    ...
    p_st_notch_fil->f4_omega_t = (PFC_TWOPI * f4_omega) * f4_samp_period;    /* w*Ts */
    f4_temp0 = p_st_notch_fil->f4_omega_t / 2.0f;                            /* w*Ts/2 */
    f4_temp0 = tanf(f4_temp0);                                               /* k = tan(w*Ts/2) */
    f4_temp1 = f4_temp0 * f4_temp0;                                          /* k^2 */
    f4_temp2 = 2.0f * f4_zeta * f4_temp0;                                    /* 2*z*k */
    f4_temp3 = f4_temp2 * f4_d;                                              /* 2*d*z*k */

    p_st_notch_fil->f4_coef_n[2] = 1 - f4_temp3 + f4_temp1;                  /* 1 - (2*d*z*k) + (k^2) */
    p_st_notch_fil->f4_coef_n[1] = (2 * f4_temp1) - 2;                       /* 2*k^2 - 2 */
    p_st_notch_fil->f4_coef_n[0] = 1 + f4_temp3 + f4_temp1;                  /* 1 + (2*d*z*k) + (k^2) */
    p_st_notch_fil->f4_coef_d[2] = 1 - f4_temp2 + f4_temp1;                  /* 1 - (2*z*k) + (k^2) */
    p_st_notch_fil->f4_coef_d[1] = (2 * f4_temp1) - 2;                       /* 2*k^2 - 2 */
    p_st_notch_fil->f4_coef_d[0] = 1 + f4_temp2 + f4_temp1;                  /* 1 + (2*z*k) + (k^2) */
} /* End of function pfc_filter_notch_coef_calc */

/***********************************************************************************************************************
* Function Name : pfc_filter_notch
...
float pfc_filter_notch(st_pfc_notch_fil_t *p_st_notch_fil, float f4_input)
{
    ...
    p_st_notch_fil->f4_in_data[2] = p_st_notch_fil->f4_in_data[1];
    p_st_notch_fil->f4_in_data[1] = p_st_notch_fil->f4_in_data[0];
    p_st_notch_fil->f4_in_data[0] = f4_input;

    p_st_notch_fil->f4_out_data[2] = p_st_notch_fil->f4_out_data[1];
    p_st_notch_fil->f4_out_data[1] = p_st_notch_fil->f4_out_data[0];

    p_st_notch_fil->f4_out_data[0] = 1.0f / p_st_notch_fil->f4_coef_d[0]
                                     *(p_st_notch_fil->f4_coef_n[2] * p_st_notch_fil->f4_in_data[2]
                                     + p_st_notch_fil->f4_coef_n[1] * p_st_notch_fil->f4_in_data[1]
                                     + p_st_notch_fil->f4_coef_n[0] * p_st_notch_fil->f4_in_data[0]
                                     - p_st_notch_fil->f4_coef_d[2] * p_st_notch_fil->f4_out_data[2]
                                     - p_st_notch_fil->f4_coef_d[1] * p_st_notch_fil->f4_out_data[1]);

    f4_temp0 = p_st_notch_fil->f4_out_data[0];

    return (f4_temp0);
} /* End of function pfc_filter_notch */
