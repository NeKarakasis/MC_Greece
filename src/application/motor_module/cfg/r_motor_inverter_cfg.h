...
#define     INVERTER_CFG_SHUNT_RESIST           (0.120f)//  (0.047f)               /* Resistance of shunt resistor [ohm] */
...
#define     INVERTER_CFG_COMP_V0      (1.824f)     // (2.432f/2)    //  (0.624f)
#define     INVERTER_CFG_COMP_V1      (3.648f)     // (4.864f/2)   // (1.248f)
#define     INVERTER_CFG_COMP_V2      (5.472)  //  (7.296f/2)   // (1.872f)
#define     INVERTER_CFG_COMP_V3      (7.296)    //  (9.728f/2)    //(2.496f)
#define     INVERTER_CFG_COMP_V4      (9.12)  //   (12.16f/2)    //(3.120f)

#define     INVERTER_CFG_COMP_I0              (0.07f) // (0.084f)
#define     INVERTER_CFG_COMP_I1               (0.14f)// (0.168f)
#define     INVERTER_CFG_COMP_I2               (0.22f)// (0.264f)
#define     INVERTER_CFG_COMP_I3               (0.3f)// (0.360f)
#define     INVERTER_CFG_COMP_I4               (0.5f)// (0.600f)
