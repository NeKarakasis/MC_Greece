...
extern float         com_f4_volt_pulse_inj_boot_on_the_fly;
extern float         com_f4_volt_pulse_inj_running_on_the_fly;
extern uint8_t       com_u1_pulse_freq_boot_on_the_fly;
extern uint8_t       com_u1_pulse_freq_drive_on_the_fly;


#define     MOTOR_MCU_CFG_PWM_TIMER_FREQ        (120.0f)                        /* PWM timer frequency [MHz] */
#define     MOTOR_MCU_CFG_CARRIER_FREQ          (14.0f)                          /* Carrier wave frequency [kHz] */
...
#define     MOTOR_COMMON_CFG_OVERCURRENT_MARGIN_MULT    (1.10f)
...
#define     CURRENT_CFG_OMEGA                   (100.0f)//(150.0f)                             /* natural frequency for current loop */
...
#define     CURRENT_CFG_ESTLOW_PULSEVOLT         com_f4_volt_pulse_inj_boot_on_the_fly      // (240.0f)                            /* Natural frequency of PLL Speed estimate loop */
#define     CURRENT_CFG_ESTLOW_PULSEVOLT_RUNNING com_f4_volt_pulse_inj_running_on_the_fly   //(70.0f)                            /* Natural frequency of PLL Speed estimate loop */
...
#define     CURRENT_CFG_PLL_ESTLOW_OMEGA         (8.0f)                             /* Natural frequency of PLL Speed estimate loop */
...
#define     CURRENT_CFG_ESTLOW_PULSEFREQ_BOOT     com_u1_pulse_freq_boot_on_the_fly  //(8)                                 /* Pulse injection frequency 1/f at the boot mode */
#define     CURRENT_CFG_ESTLOW_PULSEFREQ_DRIVE    com_u1_pulse_freq_drive_on_the_fly //(5)                                 /* Pulse injection frequency 1/f at the drive */
...
#define     SPEED_CFG_OMEGA                     (0.3f)//(0.5f) //(15.0f)          /* natural frequency for speed loop */
#define     SPEED_CFG_ZETA                      (1.0f)          /* damping ratio for speed loop */
#define     SPEED_CFG_LPF_OMEGA                 (30.0f)         /* natural frequency for speed LPF */
...
#define     SPEED_CFG_RATE_LIMIT_RPM            (2000.0f)        /* Rate limit of speed change [rpm/s] */
...
#define     MOTOR_COMMON_CURRENT_OBS_LIMIT      (1.2f)//(MOTOR_CFG_NOMINAL_CURRENT_RMS * MTR_SQRT_3 * 3.0f)
