...
target_link_directories(${PROJECT_NAME}.elf
    ...
    ${CMAKE_CURRENT_SOURCE_DIR}/"${workspace_loc:/${ProjName}/src/application/motor_module/current}"
    ${CMAKE_CURRENT_SOURCE_DIR}/"${workspace_loc:/${ProjName}/src/application/motor_module/sensorless_vector}"
    ${CMAKE_CURRENT_SOURCE_DIR}/"${workspace_loc:/${ProjName}/src/application/motor_module/speed}"
)
