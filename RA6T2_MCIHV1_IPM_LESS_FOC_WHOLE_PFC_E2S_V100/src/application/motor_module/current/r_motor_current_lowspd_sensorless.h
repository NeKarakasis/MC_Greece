...
#define     MOTOR_SENSORLESS_VECTOR_THRESHOLD_HIGHSPEED  (54.9779f)  /* 525 r/min -> 525/60 * 2PI =   rad/s */
#define     MOTOR_SENSORLESS_VECTOR_THRESHOLD_LOWSPEED   (49.7419f)  /* 475 r/min -> 475/60 * 2PI =   rad/s */
