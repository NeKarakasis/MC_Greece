...
***********************************************************************************************************************/
/* Estimate Mode state*/
#define     CURRENT_STATE_ESTMODE_POWEROFF        (0)  /* Initial State*/
#define     CURRENT_STATE_ESTMODE_INIT            (1)  /* Gete off State */
#define     CURRENT_STATE_ESTMODE_POSEST          (2)  /* Magnetic pole position estimation and polarity */
                                                       /* discrimination.*/
#define     CURRENT_STATE_ESTMODE_DRIVE_SLOW      (3)  /* Low speed driving */
#define     CURRENT_STATE_ESTMODE_DRIVE_MID       (4)  /* Switch from low speed to high speed operation */
#define     CURRENT_STATE_ESTMODE_DRIVE_HIGH      (5)  /* Medium and high speed driving*/
#define     CURRENT_STATE_ESTMODE_DRIVE_MID_M     (6)  /* Switch from high speed to low speed operation*/
...
typedef struct
{
    ...
    float                f4_timelead;                       /* Output phase of Torque Vibration Compensation */
...
typedef struct
{
    ...
    uint8_t               u1_flag_volt_err_comp_use;        /* Voltage error compensation use flag */
    uint8_t               u1_state_estmode;                 /* Estimate Mode */
    uint8_t               u1_flag_stall_detection_use;      /* Stall Detection use flag */
    uint8_t               u1_flag_trq_vibration_comp_use;   /* Torque vibration compensation use flag */
    ...
    float                 f4_vd_ref2;                       /* The reference q-axis voltage value [V] (excl pulse injection voltage) */
    ...
    st_pll_est_t          st_pll_est_low;                   /* PLL estimator structure */
    ...
    st_lowspd_sensorless_t st_lowspd;                       /* Low speed sensorless structure */
