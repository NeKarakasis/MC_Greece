...
/***********************************************************************************************************************
* Function Name: R_Config_MOTOR_StartTimerCtrl
...
* Arguments    : u2_duty_u - U phase duty register value
*                u2_duty_v - V phase duty register value
*                u2_duty_w - W phase duty register value
* Return Value : None
***********************************************************************************************************************/
void R_Config_MOTOR_UpdDuty(uint16_t u2_duty_u, uint16_t u2_duty_v, uint16_t u2_duty_w)
{
    uint32_t u4_duty_cnt_u = u2_duty_u;
    uint32_t u4_duty_cnt_v = u2_duty_v;
    uint32_t u4_duty_cnt_w = u2_duty_w;
