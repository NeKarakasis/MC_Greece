...
float pfc_ctrl_duty_limit(st_pfc_ctrl_t *p_st_pfc_ctrl, float f4_duty, float f4_max, float f4_min)
{
    ...
    {
        f4_temp = f4_max;
        p_st_pfc_ctrl->u1_duty_lower_limit_flg = PFC_FLG_CLR;
    }
    else if (f4_duty < f4_min)
    {
        f4_temp = f4_min;
        p_st_pfc_ctrl->u1_duty_lower_limit_flg = PFC_FLG_SET;
    }
    else
    {
        p_st_pfc_ctrl->u1_duty_lower_limit_flg = PFC_FLG_CLR;
    ...
    return (f4_temp);
} /* End of function pfc_ctrl_duty_limitf */
