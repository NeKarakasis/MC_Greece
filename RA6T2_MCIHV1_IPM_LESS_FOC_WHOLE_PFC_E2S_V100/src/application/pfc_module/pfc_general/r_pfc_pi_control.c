...
float pfc_pi_ctrl(st_pfc_pi_ctrl_t *p_st_pi_ctrl)
{
    ...
    p_st_pi_ctrl->f4_refp = f4_refp;

    /*** Integral part limit ***/
    f4_refi = pfc_filter_limitf_abs(f4_refi, f4_ilimit);
    p_st_pi_ctrl->f4_refi = f4_refi;

    f4_ref = f4_refp + f4_refi;                    /* PI output */
    f4_ref = pfc_filter_limitf_abs(f4_ref, f4_ilimit);

    return (f4_ref);
} /* End of function pfc_pi_ctrl */

/***********************************************************************************************************************
* Function Name : pfc_pi_ctrl_reset
...
} /* End of function pfc_pi_ctrl_reset */

/***********************************************************************************************************************
* Function Name : pfc_pi_ctrl_kp_set
...
} /* End of function pfc_pi_ctrl_kp_set */

/***********************************************************************************************************************
* Function Name : pfc_pi_ctrl_ki_set
...
} /* End of function pfc_pi_ctrl_ki_set */

/***********************************************************************************************************************
* Function Name : pfc_pi_ctrl_integrator_set
...
} /* End of function pfc_pi_ctrl_integrator_set */

/***********************************************************************************************************************
* Function Name : pfc_pi_ctrl_integral_limit_set
...
} /* End of function pfc_pi_ctrl_integral_limit_set */

/***********************************************************************************************************************
* Function Name : pfc_pi_ctrl_proportion_get
* Description   : Gets proportional term value of PI control
* Arguments     : p_st_pi_ctrl - The pointer to the PI control structure
* Return Value  : The proportional term value
***********************************************************************************************************************/
float pfc_pi_ctrl_proportion_get(st_pfc_pi_ctrl_t *p_st_pi_ctrl)
{
    return (p_st_pi_ctrl->f4_refp);
} /* End of function pfc_pi_ctrl_proportion_get */

/***********************************************************************************************************************
* Function Name : pfc_pi_ctrl_integrator_get
* Description   : Gets integrator value of PI control
* Arguments     : p_st_pi_ctrl - The pointer to the PI control structure
* Return Value  : The integrator value
***********************************************************************************************************************/
float pfc_pi_ctrl_integrator_get(st_pfc_pi_ctrl_t *p_st_pi_ctrl)
{
    return (p_st_pi_ctrl->f4_refi);
} /* End of function pfc_pi_ctrl_integrator_get */
