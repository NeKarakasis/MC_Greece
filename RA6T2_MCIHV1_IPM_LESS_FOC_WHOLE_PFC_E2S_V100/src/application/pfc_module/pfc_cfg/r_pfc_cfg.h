...
#define PFC_MCU_CFG_SAMP_PERIOD           (1.0f / PFC_MCU_CFG_CARRIER_FREQ / 1000.0f)
                                                              /* Sampling period [s] */
...
#define PFC_ACR_DUTY_FF_CTRL_CNT_LIMIT  (PFC_ACR_DUTY_FF_CTRL_TIME * PFC_MCU_CFG_CARRIER_FREQ * 1000.0f)
...
#define RELAY_ON_DELAY_CNT      (RELAY_ON_DELAY_TIME * PFC_MCU_CFG_CARRIER_FREQ * 1000.0f)
                                                   /* Waiting time count value for relay ON [count] */
#define RELAY_OFF_DELAY_CNT     (RELAY_OFF_DELAY_TIME * PFC_MCU_CFG_CARRIER_FREQ * 1000.0f)
...
#define ICHP_OVER_CURRENT           (19.0f)        /* PFC over current limit [A] */
