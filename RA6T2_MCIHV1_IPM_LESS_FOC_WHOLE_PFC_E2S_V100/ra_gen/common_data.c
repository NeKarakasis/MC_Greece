...
const icu_extended_cfg_t g_external_irq2_ext_cfg = { .filter_src =
...
const external_irq_cfg_t g_external_irq2_cfg = { .channel = 2, .trigger =
		...
		EXTERNAL_IRQ_CLOCK_SOURCE_DIV_64, .p_callback = callback_irq2_pfc_error,
/** If NULL then do not add & */
    ...
    .p_context           = NULL,
		...
		.p_context = (void*) &NULL,
#endif
		.p_extend = (void*) &g_external_irq2_ext_cfg, .ipl = (0),
