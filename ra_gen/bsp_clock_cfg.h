...
#define BSP_CFG_PLL2_MUL BSP_CLOCKS_PLL_MUL(60,0) /* PLL2 Mul x60-79|Mul x60|PLL2 Mul x60.00 */
...
#define BSP_CFG_PLL2Q_FREQUENCY_HZ (720000000) /* PLL2Q 720000000Hz */
#define BSP_CFG_PL2ODIVR (BSP_CLOCKS_PLL_DIV_2) /* PLL2R Div /2 */
#define BSP_CFG_PLL2R_FREQUENCY_HZ (720000000) /* PLL2R 720000000Hz */
...
#define BSP_CFG_FCLK_DIV (BSP_CLOCKS_SYS_CLOCK_DIV_16) /* MRPCLK Div /16 */
...
#define BSP_CFG_PCLKE_DIV (BSP_CLOCKS_SYS_CLOCK_DIV_8) /* PCLKE Div /8 */
...
#define BSP_CFG_BCLKA_DIV (BSP_CLOCKS_BCLKA_CLOCK_DIV_1) /* BCLKA Div /1 */
...
#define BSP_CFG_ESWPHYCLK_DIV (BSP_CLOCKS_ESWPHY_CLOCK_DIV_4) /* ESWPHYCLK Div /4 */
#define BSP_CFG_ETHPHYCLK_SOURCE (BSP_CLOCKS_CLOCK_DISABLED) /* ETHPHYCLK Disabled */
#define BSP_CFG_ETHPHYCLK_DIV (BSP_CLOCKS_ETHPHY_CLOCK_DIV_4) /* ETHPHYCLK Div /4 */
#define BSP_CFG_ESCCLK_SOURCE (BSP_CLOCKS_CLOCK_DISABLED) /* ESCCLK Disabled */
#define BSP_CFG_ESCCLK_DIV (BSP_CLOCKS_ESC_CLOCK_DIV_4) /* ESCCLK Div /4 */
#define BSP_CFG_DSMIFCLK_SOURCE (BSP_CLOCKS_CLOCK_DISABLED) /* DSMIFCLK Disabled */
#define BSP_CFG_DSMIFCLK_DIV (BSP_CLOCKS_DSMIF_CLOCK_DIV_4) /* DSMIFCLK Div /4 */
